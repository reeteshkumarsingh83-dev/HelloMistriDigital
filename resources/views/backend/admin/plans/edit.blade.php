                  ...
                  <div class="row gy-4">
                    <div class="col-xxl-12 col-md-12 col-12">
                      <div>
                        ...
                        <input type="text" class="form-control" name="title" id="valueInput" value="{{ $plan->title }}" placeholder="Plan Title">
                        @error('title')
                    ...
                    <div class="col-xxl-4 col-md-4 col-12">
                      <div>
                        ...
                        <input type="number" class="form-control" name="price" id="valueInput" value="{{ $plan->price }}" placeholder="Plan Price">
                        @error('price')
                             <small class="form-text text-danger">{{ $message }}</small>
                         @enderror
                      </div>
                    ...
                    <div class="col-xxl-4 col-md-4 col-12">
                      <div>
                        ...
                        <input type="number" class="form-control" name="affordable_amount" id="valueInput" value="{{ $plan->affordable_amount }}" placeholder="Affordable Amount/Per Days">
                        ...
                        <div class="dynamic_section col-sm-8 bordered">
                          <div class="row mb-3">
                            <label for="valueInput" class="form-label">Benefits Type</label>
                             @foreach($plans_benefits as $benefit)
