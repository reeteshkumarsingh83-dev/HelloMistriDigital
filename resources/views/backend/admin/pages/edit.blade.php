      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <form method="post" action="{{ route('admin.update-page') }}" enctype="multipart/form-data">
              @csrf
                  ...
                  <div class="row gy-4">
                    <div class="col-xxl-6 col-md-6 col-12">
                      <div>
                        ...
                        <input type="text" class="form-control" name="title" id="valueInput" value="{{ $page->title }}" placeholder="Page Title">
                        @error('title')
                    ...
                    <div class="col-xxl-6 col-md-6 col-12">
                      <div>
                        ...
                        <input type="text" class="form-control" name="slug" id="valueInput" value="{{ $page->slug }}" placeholder="" readonly>
                        @error('slug')
                             <small class="form-text text-danger">{{ $message }}</small>
                         @enderror
                      </div>
                    ...
                    <div class="col-xxl-6 col-md-6 col-12">
                      <div>
                        ...
                        <input type="text" class="form-control" name="url" id="" value="{{ $page->url }}" placeholder="Page Url">
                        @error('page_url')
                             <small class="form-text text-danger">{{ $message }}</small>
                         @enderror
                      </div>
                    ...
                    <div class="col-xxl-12 col-md-12 col-12">
                      <div class="card card_logo">
                        ...
                        <div class="text-center py-2">
                          <img src="{{ get_upload_image('pages/'.$page->banner) ?? ''}}" class="img-fluid" alt="" style="height:70px; padding-top:10px;">
                        </div>
                    ...
                    <div class="col-xxl-12 col-md-12">
                      <div>
                        ...
                        <textarea name="description" id="tiny_mce" class="tinymce-editor" placeholder="Type here.">{!! $page->description !!}</textarea>
                      </div>
                        @error('description')
                             <small class="form-text text-danger">{{ $message }}</small>
                         @enderror
