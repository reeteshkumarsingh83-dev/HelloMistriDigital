                ...
                <div class="live-preview">
                  <div class="row gy-4">
                    <div class="col-xxl-6 col-md-6 col-12">
                      <div>
                        ...
                        <input type="text" class="form-control" name="name" id="valueInput" value="{{ $service_id->name }}" placeholder="Name">
                        @error('name')
                      ...
                      <div class="category_icon">
                        ...
                        <div class="image_box py-2">
                          <img  src="" class="img-fluid" alt="" id="iconImage"  onerror="this.src='{{ asset("images/img2.jpg") }}'">
                           <img  src="{{ get_upload_image('services/'.$service_id->image) ?? ''}}" class="img-fluid" alt=""  onerror="this.src='{{ asset("images/img2.jpg") }}'" style="height: 200px;">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xxl-12 col-md-12">
                      <div>
                        ...
                        <textarea name="description" id="tiny_mce" class="tinymce-editor" placeholder="Type here.">{!! $service_id->description !!}</textarea>
                      </div>
                        @error('description')
                             <small class="form-text text-danger">{{ $message }}</small>
                         @enderror
