                  ...
                  <div class="row gy-4">
                    <div class="col-xxl-6 col-md-6 col-12">
                      <div>
                        ...
                        <input type="text" class="form-control" name="title" id="valueInput" value="{{ $edit_banner->title }}" placeholder="Banner Title">
                        @error('title')
                    ...
                    <div class="col-xxl-6 col-md-6 col-12">
                      <div>
                        ...
                        <input type="text" class="form-control" name="url" id="" value="{{ $edit_banner->url }}" placeholder="Banner Url">
                        @error('page_url')
                             <small class="form-text text-danger">{{ $message }}</small>
                         @enderror
                      </div>
                    ...
                    <div class="col-xxl-12 col-md-12 col-12">
                      <div class="card card_logo">
                        ...
                        <div class="text-center py-2">
                          <img src="{{ get_upload_image('banners/'.$edit_banner->banner) }}" class="img-fluid" alt="" style="height:70px; padding-top:10px;">
                        </div>
